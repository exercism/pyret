...
[list: 
  ...
  test(append-list-to-empty, false),
  test(append-empty-to-list, false),
  test(append-list-to-list, false),
  test(concatenate-empties, false),
  test(concatenate-lists, false),
  test(concatenate-nested-lists, false),
  test(filter-empty, false),
  test(filter-list, false),
  test(length-empty, false),
  test(length-list, false),
  ...
  test(foldr-direction-dependent, false),
  test(revverse-empty, false),
  test(reverse-list, false),
  test(reverse-nested, false)
