...
[list: 
  ...
  test(invalid-negative-row, false),
  test(invalid-row-not-on-board, false),
  test(invalid-negative-column, false),
  test(invalid-column-not-on-board, false),
  test(can-not-attack, false),
  test(can-attack-on-same-row, false),
  test(can-attack-on-same-column, false),
  test(can-attack-on-first-diagonal, false),
  test(can-attack-on-second-diagonal, false),
  test(can-attack-on-third-diagonal, false),
  test(can-attack-on-fourth-diagonal, false),
  test(can-not-attack-on-reflected-diagonal, false)
