...
[list: 
  ...
  test(create-clock-past-hour, false),
  test(create-clock-midnight, false),
  test(create-clock-hours-rollover, false),
  test(create-clock-hours-rollover-multiple, false),
  test(create-clock-sixty-minutes, false),
  test(create-clock-minutes-rollover, false),
  test(create-clock-minutes-rollover-multiple, false),
  test(create-clock-rollover, false),
  test(create-clock-rollover-multiple, false),
  test(create-clock-rollover-to-midnight, false),
  test(create-clock-negative-hours, false),
  test(create-clock-negative-hours-rollover, false),
  test(create-clock-negative-hours-rollover-multiple, false),
  test(create-clock-negative-minutes, false),
  test(create-clock-negative-minutes-rollover-multiple, false),
  test(create-clock-negative-sixty-minutes, false),
  test(create-clock-negative-rollover, false),
  test(create-clock-negative-rollover-multiple, false),
  test(add-minutes, false),
  test(add-no-minutes, false),
  test(add-to-hours, false),
  test(add-to-hours-multiple, false),
  test(add-to-hours-carryover, false),
  test(add-across-midnight, false),
  test(add-more-than-one-day, false),
  test(add-more-than-one-day-multiple, false),
  test(subtract-minutes, false),
  test(subtract-rollover, false),
  test(subtract-rollover-multiple, false),
  test(subtract-across-midnight, false),
  test(subtract-more-than-two-hours, false),
  test(subtract-rollover-borrow, false),
  test(subtract-more-than-a-day, false),
  test(subtract-more-than-two-days, false),
  test(equality-same-time, false),
  test(equality-a-minute-apart, false),
  test(equality-an-hour-apart, false),
  test(equality-hour-rollover, false),
  test(equality-hour-overflow-multiple, false),
  test(equality-negative-hour, false),
  test(equality-negative-hour-rollover, false),
  test(equality-negative-hour-rollover-multiple, false),
  test(equality-minute-rollover, false),
  test(equality-rollover-multiple, false),
  test(equality-negative-minute, false),
  test(equality-negative-minute-rollover, false),
  test(equality-negative-minute-rollover-multiple, false),
  test(equality-negative-hour-and-minute, false),
  test(equality-negative-hours-and-minutes-rollover, false),
  test(equality-full-clock-empty-clock, false)
