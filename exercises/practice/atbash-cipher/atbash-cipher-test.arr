...
[list: 
  ...
  test(encode-no, false),
  test(encode-OMG, false),
  test(encode-spaces, false),
  test(encode-mindblowingly, false),
  test(encode-numbers, false),
  test(encode-deep-thought, false),
  test(encode-all-letters, false),
  test(decode-exercism, false),
  test(decode-sentence, false),
  test(decode-numbers, false),
  test(decode-all-letters, false),
  test(decode-with-too-many-spaces, false),
  test(decode-with-no-spaces, false)
