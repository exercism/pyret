...
[list: 
  ...
  test(latest-score, false),
  test(personal-best, false),
  test(top-three, false),
  test(top-three-is-sorted, false),
  test(top-three-with-tie, false),
  test(top-three-when-less-than-three, false),
  test(top-three-when-only-one, false)
