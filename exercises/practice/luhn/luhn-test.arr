...
[list: 
  ...
  test(invalid-single-zero, false),
  test(valid-even-if-reversed, false),
  test(valid-but-not-reversed, false),
  test(valid-canadian, false),
  test(invalid-canadian, false),
  test(invalid-credit-card, false),
  test(invalid-long-number-even-remainder, false),
  test(invalid-long-number-remainder-div-by-five, false),
  test(valid-number-with-even-number-of-digits, false),
  test(valid-number-with-odd-nummber-of-spaces, false),
  test(invalid-number-after-non-digit-added, false),
  test(invalid-number-after-punctuation-added, false),
  test(invalid-number-after-symbols-added, false),
  test(invalid-space-and-zero, false),
  test(valid-multiple-zeroes, false),
  test(valid-input-digit-nine, false),
  test(valid-very-long-input, false),
  test(valid-with-odd-number-of-digits-and-non-zero-first-digit, false),
  test(invalid-number-with-ascii-non-double, false),
  test(invalid-number-with-ascii-doubled, false),
  test(invalid-number-with-non-space-letter, false)
