...
[list: 
  test(wink, true),
  test(double-blink, false),
  test(close-your-eyes, false),
  test(jump, false),
  test(combine-two-actions, false),
  test(reverse-two-actions, false),
  test(reversed-action-is-same, false),
  test(reversed-inaction-is-same, false),
  test(all-possible-actions, false),
  test(all-possible-actions-reversed, false),
  test(do-nothing, false)
