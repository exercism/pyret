...
[list: 
  ...
  test(slices-of-one-from-two, false),
  test(slices-of-two, false),
  test(slices-of-two-overlap, false),
  test(slices-can-include-duplicates, false),
  test(slices-of-a-long-series, false),
  test(slice-length-too-large, false),
  test(slice-length-way-too-large, false),
  test(slice-length-can-not-be-zero, false),
  test(slice-length-can-not-be-negative, false),
  test(empty-series-is-invalid, false)
