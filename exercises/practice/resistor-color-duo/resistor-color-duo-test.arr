...
[list: 
  ...
  test(blue-and-grey, false),
  test(yellow-and-violet, false),
  test(white-and-red, false),
  test(orange-and-orange, false),
  test(ignore-additional-colors, false),
  test(black-and-brown, false)
