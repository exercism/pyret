...
[list: 
  ...
  test(clean-number-with-dots, false),
  test(clean-number-with-spaces, false),
  test(invalid-nine-digits, false),
  test(invalid-eleven-digits-starting-with-two, false),
  test(valid-eleven-digits-starting-with-one, false),
  test(valid-eleven-digits-starting-with-one-and-punctuation, false),
  test(invalid-more-than-eleven-digits, false),
  test(invalid-with-letters, false),
  test(invalid-with-punctuation, false),
  test(invalid-area-code-starts-with-zero, false),
  test(invalid-area-code-starts-with-one, false),
  test(invalid-exchange-code-starts-with-zero, false),
  test(invalid-exchange-code-starts-with-one, false),
  test(invalid-eleven-digits-and-area-code-starts-with-zero, false),
  test(invalid-eleven-digits-and-area-code-starts-with-one, false),
  test(invalid-eleven-digits-and-exchange-code-starts-with-zero, false),
  test(invalid-eleven-digits-and-exchange-code-starts-with-one, false)
