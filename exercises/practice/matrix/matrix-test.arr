...
[list: 
  ...
  test(extract-row-from-two-row-matrix, false),
  test(extract-row-from-variable-number-width-matrix, false),
  test(extract-row-from-non-square-matrix, false),
  test(extract-column-from-one-column-matrix, false),
  test(extract-column-from-three-column-matrix, false),
  test(extract-column-from-non-square-matrix, false),
  test(extract-column-from-variable-number-width-matrix, false)
