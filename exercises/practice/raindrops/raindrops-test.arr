...
[list: 
  test(convert-1, true),
  test(convert-3, false),
  test(convert-5, false),
  test(convert-7, false),
  test(convert-6, false),
  test(convert-8, false),
  test(convert-9, false),
  test(convert-10, false),
  test(convert-14, false),
  test(convert-15, false),
  test(convert-21, false),
  test(convert-25, false),
  test(convert-27, false),
  test(convert-35, false),
  test(convert-49, false),
  test(convert-52, false),
  test(convert-105, false)
