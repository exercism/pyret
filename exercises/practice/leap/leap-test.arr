...
[list: 
  ...
  test(divisible-by-2-not-4, false),
  test(divisible-by-4-not-100, false),
  test(divisible-by-4-and-5, false),
  test(divisible-by-100-not-400, false),
  test(divisible-by-100-not-3, false),
  test(divisible-by-400, false),
  test(divisible-by-400-not-125, false),
  test(divisible-by-200-not-400, false)
